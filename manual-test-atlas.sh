#!/bin/bash
# Manual test of Atlas MCP server using direct TypeScript execution

echo "=== Testing Atlas Session Lifecycle ==="
echo

# Create a test script that uses the library directly
cat > /tmp/test-atlas-session.mjs << 'SCRIPT'
import { startSession, saveMemory, recordDecision, endSession } from '/home/greyw0rks/atlas-2/lib/memory/writer.js';
import { getRepositoryContext, getOpenTasks } from '/home/greyw0rks/atlas-2/lib/memory/retrieval.js';
import { scanRepository } from '/home/greyw0rks/atlas-2/lib/intelligence/repo-scanner.js';
...
# Run the test
node /tmp/test-atlas-session.mjs
